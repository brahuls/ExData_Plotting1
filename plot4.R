###############################################################################
## $Header:: "plot4.R"; version v 1.0.0 2019-04-21
...
plot4<- function(){
  ...
  ## Preparing for 4 graphs in 2x2 format
        par(mfrow=c(2,2))
        
        with(subsetdata, plot(FullTimeDate, Global_active_power, type="l", 
                              xlab="", ylab="Global Active Power"))
        with(subsetdata, plot(FullTimeDate, Voltage, type = "l", xlab="datetime",
                              ylab="Voltage"))
        ...
        legend(c("topright"), c("Sub_metering_1", "Sub_metering_2", 
               ...
               bty="n")
        with(subsetdata, plot(FullTimeDate, Global_reactive_power, type="l", 
